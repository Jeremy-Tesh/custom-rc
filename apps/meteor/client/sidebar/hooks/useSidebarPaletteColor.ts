...
const getStyle = (
	...
	(colors: { [key: string]: string }): string =>
		...
		${selector} {
			...
			--rcx-button-icon-active-border-color: ${toVar(colors.b100)};;
			--rcx-button-icon-active-background-color: none;
			--rcx-button-icon-color: ${toVar(colors.sibebarSurface)};
			--rcx-button-icon-border-color: ${toVar(colors.b100)};
			--rcx-button-icon-background-color: ${toVar(colors.b100)} ;
			--rcx-button-icon-hover-background-color: ${toVar(colors.b100)};
			--rcx-button-icon-hover-border-color: ${toVar(colors.b100)};
			--rcx-button-icon-focus-background-color:  none;
			--rcx-button-icon-focus-border-color: ${toVar(colors.b100)};
			--rcx-button-icon-focus-shadow-color: none;

			--rcx-button-icon-success-active-border-color: ${toVar(colors.b100)};;
			--rcx-button-icon-success-active-background-color: ${toVar(colors.n800)};
			--rcx-button-icon-success-color: ${toVar(colors.n600)};
			--rcx-button-icon-success-border-color: ${toVar(colors.b100)};;
			...
			--rcx-button-icon-success-hover-border-color: ${toVar(colors.b100)};;


			--rcx-sidebar-item-background-color-hover: ${toVar(colors.b100)};
			--rcx-sidebar-item-background-color-selected: none;
			...
			--rcx-button-icon-disabled-border-color: ${toVar(colors.b100)};;

			--rcx-divider-color: ${h2r(toVar(colors.n400), 0.4)};
			--rcx-color-foreground-alternative: ${toVar(colors.n100)};
			--rcx-color-foreground-hint: ${toVar(colors.n600)};

			--rcx-sidebar-title-color: var(--rcx-color-neutral-300, ${toVar(colors.n400)});
			--rcx-sidebar-item-color: var(--rcx-color-neutral-100, ${toVar(colors.n400)});
			--rcx-sidebar-item-color-hover: var(--rcx-color-neutral-300, ${toVar(colors.n400)});
			--rcx-sidebar-item-color-selected: var(--rcx-color-neutral-100, ${toVar(colors.n400)});
			--rcx-sidebar-footer-highlight-color: var(--rcx-color-neutral-300, ${toVar(colors.n400)});
			--rcx-sidebar-item__time:#ff0000;
