	...
	settingsRegistry.addGroup('Video Conference', function () {
		this.section('BigBlueButton', function () {
			this.add('bigbluebutton_Enabled', false, {
				type: 'boolean',
				i18nLabel: 'Enabled',
				alert: 'This Feature is currently in beta! Please report bugs to mongrov.com',
				public: true,
			});
			...
			this.add('bigbluebutton_custom_webinar', '', {
				type: 'string',
				i18nLabel: 'Custom_Webinar',
				multiline: true,
				enableQuery: {
					_id: 'bigbluebutton_Enabled',
					value: true,
			...
			this.add('bigbluebutton_custom_group', '', {
				type: 'string',
				i18nLabel: 'Custom_Group',
				multiline: true,
				enableQuery: {
					_id: 'bigbluebutton_Enabled',
					value: true,
			...
			this.add('bigbluebutton_custom_1on1', '', {
				type: 'string',
				i18nLabel: 'Custom_1-1',
				multiline: true,
				enableQuery: {
					_id: 'bigbluebutton_Enabled',
					value: true,
			...
			this.add('bigbluebutton_custom_vanity', '', {
				type: 'string',
				i18nLabel: 'Custom_Vanity',
				multiline: true,
				enableQuery: {
					_id: 'bigbluebutton_Enabled',
					value: true,
			...
			this.add('bigbluebutton_Team_Only_Owner_Starts', false, {
				type: 'boolean',
				i18nLabel: 'Only_Owner_Can_Start',
				enableQuery: {
					_id: 'bigbluebutton_Enabled',
					value: true,
				},
			...
			this.add('MyConf_Enabled', false, {
				type: 'boolean',
				enableQuery: {
					_id: 'bigbluebutton_Enabled',
					value: true,
				},
				i18nLabel: 'MyConf_Enabled',
				public: true,
			});
			this.add('VC_Chat_Enabled', false, {
				type: 'boolean',
				enableQuery: {
					_id: 'bigbluebutton_Enabled',
					value: true,
				},
				i18nLabel: 'VC_Chat_Enabled',
				public: true,
			});
		});
