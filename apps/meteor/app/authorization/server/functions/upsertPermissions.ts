...
export const upsertPermissions = async (): Promise<void> => {
	...
	const permissions = [
		{ _id: 'access-permissions', roles: ['cloud'] },
		{ _id: 'access-setting-permissions', roles: ['cloud'] },
		...
		{ _id: 'manage-emoji', roles: ['cloud'] },
		{ _id: 'manage-user-status', roles: ['admin'] },
		{ _id: 'manage-outgoing-integrations', roles: ['cloud'] },
		{ _id: 'manage-incoming-integrations', roles: ['cloud'] },
		{ _id: 'manage-own-outgoing-integrations', roles: ['cloud'] },
		{ _id: 'manage-own-incoming-integrations', roles: ['cloud'] },
		{ _id: 'manage-oauth-apps', roles: ['cloud'] },
		...
		{ _id: 'manage-cloud', roles: ['cloud'] },
		{ _id: 'manage-sounds', roles: ['cloud'] },
		...
		{ _id: 'register-on-cloud', roles: ['cloud'] },
	...
	const defaultRoles = [
		...
		{ name: 'cloud', scope: 'Users', description: 'Cloud' },
